# Multiple Imputation with Chained Equations with Re-parametrized Hearing Data
# Author: Bruce Zhou
# Date: `r Sys.Date()`
...
meth[3:16] <- "2l.bin" # Level-1 categorical variables
meth[c("hr", "gait", "cstand", "hhconsumpLevel", "mbmi", "balance")] <- "2l.lmer" # Level-1 continuous/nominal variables
