### Objective: Generate DTA file for Stata Multiple Imputation ###
...
write_dta("outputs/pooled_11_15.dta", data = pooled_11_15, version = 15)
save(pooled_11_15, file = "outputs/pooled_11_15_full.RData")