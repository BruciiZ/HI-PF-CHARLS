...
gen reversed_balance = 4 - balance + 1

* Estimate the average difference - model 1 (Mixed-Effects Ordinal Logistic Regression)
meologit reversed_balance i.hr centered_age i.sex i.newWave || id:, ///
...
meologit reversed_balance i.hr centered_age i.sex i.residence i.education ///
