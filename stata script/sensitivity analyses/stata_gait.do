...
gen reversed_gaitScore = 4 - gaitScore + 1

* Estimate the average difference - model 1 (Mixed-Effects Ordinal Logistic Regression)
meologit reversed_gaitScore i.hr centered_age i.sex i.newWave || id:, ///
...
meologit reversed_gaitScore i.hr centered_age i.sex i.residence i.education ///
