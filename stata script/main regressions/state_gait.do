...
xtgee gait i.hr age i.sex i.newWave, family(gaussian) link(identity) corr(unstructured) vce(robust) cformat(%9.2f) pformat(%5.3f) sformat(%8.0g)

* Estimate the average difference - model 2
xtgee gait i.hr age i.sex i.residence i.education i.marital i.hhconsumpLevel i.newWave, family(gaussian) link(identity) corr(unstructured) vce(robust) cformat(%9.2f) pformat(%5.3f) sformat(%8.0g)

* Estimate the average difference - model 3
xtgee gait i.hr age i.sex i.residence i.education i.marital i.hhconsumpLevel i.mbmi i.smoke i.drink i.newWave, family(gaussian) link(identity) corr(unstructured) vce(robust) cformat(%9.2f) pformat(%5.3f) sformat(%8.0g)

* Estimate the average difference - model 4
xtgee gait i.hr age i.sex i.residence i.education i.marital i.hhconsumpLevel i.mbmi i.smoke i.drink i.hibpe i.diabe i.cancer i.lunge i.hearte i.stroke i.arthre i.dyslipe i.livere i.kidneye i.asthmae i.newWave, family(gaussian) link(identity) corr(unstructured) vce(robust) cformat(%9.2f) pformat(%5.3f) sformat(%8.0g)
...
xtgee gait i.hr##c.visit age i.sex i.residence i.education i.marital i.hhconsumpLevel i.mbmi i.smoke i.drink i.hibpe i.diabe i.cancer i.lunge i.hearte i.stroke i.arthre i.dyslipe i.livere i.kidneye i.asthmae i.newWave, family(gaussian) link(identity) corr(unstructured) vce(robust) cformat(%9.2f) pformat(%5.3f) sformat(%8.0g)
